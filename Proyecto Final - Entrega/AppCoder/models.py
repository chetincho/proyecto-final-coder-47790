...
class Avatar(models.Model):
    ...
    # imagen = models.ImageField(upload_to='avatares',null=True, blank = True)   -- Comentado a las 13/12/23 23:57
    imagen = models.FileField(upload_to="media/avatares", null=True, blank=True)    # Agregado a las 13/12/23 23:57

    def __str__(self):                              # Agregado a las 13/12/23 23:57
        return f"{self.user} - {self.imagen}"       # Agregado a las 13/12/23 23:57